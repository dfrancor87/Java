...
public class Main {
    ...
    public static void insertarPersonajePelicula(Session session) {
        ...
        Personaje personaje = new Personaje("Tony Stark", "Iron Man");
        Set<Pelicula> peliculas = new HashSet<Pelicula>();
        peliculas.add(new Pelicula("Iron man 1", personaje));
        peliculas.add(new Pelicula("Iron man 2", personaje));
        peliculas.add(new Pelicula("Los vengadores", personaje));
